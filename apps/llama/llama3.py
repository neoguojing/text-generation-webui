...
class Llama3(CustomerLLM):
    ...
    def __init__(self, model_path: str,**kwargs):
        ...
        # tokenizer.save_pretrained(os.path.join(model_root,"llama3-base"))
        ...
        # model.save_pretrained(os.path.join(model_root,"llama3-base"))
...
if __name__ == '__main__':
    ...
    俄乌战争
    '''
    # model = Llama3(model_path=os.path.join(model_root,"llama3-base"))
    # out = model._call(prompt,system="你是一个政治专家,请使用中文",history=[["二战","不知道"]])
    # print(out)

    pipeline = transformers.pipeline(
            "text-generation", model=os.path.join(model_root,"llama3-base") , model_kwargs={"torch_dtype": torch.bfloat16}, device_map="auto"
        )
